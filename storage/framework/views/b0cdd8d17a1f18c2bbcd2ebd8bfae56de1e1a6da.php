    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card" style="background-color: rgba(255, 255, 255, 0.0);">
                <div class="card-header"style="background-color: #C43F52;"><span style="color: white;"><?php echo e(__('About Us')); ?></span></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\cells\OneDrive\Documents\GitHub\NpcDev\resources\views/About.blade.php ENDPATH**/ ?>